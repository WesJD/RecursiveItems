...
public class ItemEngine {
     ...
     * @throws RuntimeException if the {@link ItemStack} involved doesn't have a worth
     */
    public void removeWorth(ItemStack stack) throws RuntimeException {
        if (main.getConfig().contains("defined." + stack.getType()))
            main.getConfig().set("defined." + stack.getType(), null);
        else throw new RuntimeException("No explicit worth set for ItemStack");
    }
